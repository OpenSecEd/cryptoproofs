Module: Cryptographic Proofs (cryptoproofs)
===============================================================================

This is a learning module for Cryptographic Proofs.  It's aim is to cover 
common proof techniques used in cryptography and security.
...
- `games` contains a learning session for game-based proofs.  It's based on the 
  Shoup and Bellare-Rogaway techniques.
